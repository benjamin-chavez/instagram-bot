...
following_btn = driver.find_element(:xpath, '/html/body/div[1]/section/main/div/header/section/ul/li[3]/a')
following_btn.click
sleep(2)
scroll = driver.find_element(:xpath, '/html/body/div[4]/div/div/div[2]')
my_range = (1..20)
...
unfollow_array.each do |account|
  user_account = account[0].to_s
    unless user_account == 'PEOPLE' || user_account == 'HASHTAGS'
      ...
      sleep(5)
      begin
      follow_button = driver.find_element(:xpath, '/html/body/div[1]/section/main/div/header/section/div[1]/div[2]/span/span[1]/button')
      follow_button.click
      sleep(4)
      rescue Exception => e
        ...
        unfollow_notification = driver.find_element(:xpath, '/html/body/div[4]/div/div/div/div[3]/button[1]')
